import{c as k,_ as u}from"./codePreview.3e0f30ff.js";import{d as w,i as C,j as _,b as a,c as B,e as t,g as l,l as e,f as b,K as m,w as p,B as f,Z as v}from"./index.84bf9faa.js";import{I as E}from"./icon-bell.7be3ea13.js";import{I as h}from"./icon-code.87b52d55.js";const $=t("ul",{class:"flex space-x-2 rtl:space-x-reverse"},[t("li",null,[t("a",{href:"javascript:;",class:"text-primary hover:underline"},"Components")]),t("li",{class:"before:content-['/'] ltr:before:mr-2 rtl:before:ml-2"},[t("span",null,"Notifications")])],-1),j={class:"pt-5 space-y-8"},T={class:"panel p-3 flex items-center text-primary overflow-x-auto whitespace-nowrap"},M={class:"ring-2 ring-primary/30 rounded-full bg-primary text-white p-1.5 ltr:mr-3 rtl:ml-3"},S=t("span",{class:"ltr:mr-3 rtl:ml-3"},"Documentation: ",-1),N=t("a",{href:"https://www.npmjs.com/package/sweetalert2",target:"_blank",class:"block hover:underline"},"https://www.npmjs.com/package/sweetalert2",-1),D={class:"grid grid-cols-1 lg:grid-cols-2 gap-6"},I={class:"panel"},A={class:"flex items-center justify-between mb-5"},H=t("h5",{class:"font-semibold text-lg dark:text-white-light"},"Basic",-1),P={class:"flex items-center"},L={class:"mb-5"},R={class:"flex items-center justify-center"},V=t("pre",null,`<!-- basic -->
...
<\/script>
`,-1),O={class:"panel lg:row-span-2"},W={class:"flex items-center justify-between mb-5"},K=t("h5",{class:"font-semibold text-lg dark:text-white-light"},"Position",-1),Z={class:"flex items-center"},q={class:"mb-5"},z=t("h6",{class:"font-semibold text-base dark:text-white-light mb-3 text-center"},"Top Position",-1),F={class:"flex items-center justify-center mb-10 gap-2"},G=t("h6",{class:"font-semibold text-base dark:text-white-light mb-3 text-center"},"Bottom Position",-1),J={class:"flex items-center justify-center gap-2"},Q=t("pre",null,`<!-- top left -->
...
<\/script>
`,-1),U={class:"panel"},X={class:"flex items-center justify-between mb-5"},Y=t("h5",{class:"font-semibold text-lg dark:text-white-light"},"No Action",-1),tt={class:"flex items-center"},ot={class:"mb-5"},st={class:"flex items-center justify-center"},et=t("pre",null,`<!-- no action -->
