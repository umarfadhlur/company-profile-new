...
`,-1),A={class:"panel"},S={class:"flex items-center justify-between mb-5"},G=t("h5",{class:"font-semibold text-lg dark:text-white-light"},"Input Group",-1),M={class:"flex items-center"},z=_('<div class="mb-5"><div class="flex flex-wrap justify-center sm:justify-between items-center gap-4 w-full"><div><div class="relative inline-flex align-middle"><button type="button" class="btn btn-dark ltr:rounded-r-none rtl:rounded-l-none">1</button><button type="button" class="btn btn-dark rounded-none">2</button><button type="button" class="btn btn-dark rounded-none">3</button><button type="button" class="btn btn-dark ltr:rounded-l-none rtl:rounded-r-none">4</button></div></div><div class="flex relative items-stretch flex-wrap"><div class="ltr:-mr-px rtl:-ml-px flex"><span class="border border-[#e0e6ed] dark:border-[#17263c] ltr:rounded-l rtl:rounded-r bg-[#f1f2f3] flex items-center justify-center text-black px-4 py-1.5 dark:bg-[#1a1c2d] dark:text-white-dark">@</span></div><input type="text" placeholder="Input group example" class="flex-1 form-input ltr:rounded-l-none rtl:rounded-r-none"></div></div></div>',1),E=t("pre",null,`<!-- button group -->
<div>
  <div class="relative inline-flex align-middle">
...
`,-1),L={class:"panel"},R={class:"flex items-center justify-between mb-5"},H=t("h5",{class:"font-semibold text-lg dark:text-white-light"},"Vertical",-1),K={class:"flex items-center"},T={class:"mb-5 text-center"},q={class:"relative inline-flex align-middle flex-col items-start justify-center"},F=t("button",{type:"button",class:"btn btn-dark rounded-b-none w-full"},"Button",-1),J={class:"dropdown"},O={href:"javascript:;",class:"btn dropdown-toggle btn-dark rounded-none"},Q=["onClick"],U=t("li",null,[t("a",{href:"javascript:;"},"Dropdown link")],-1),W=t("li",null,[t("a",{href:"javascript:;"},"Dropdown link")],-1),X=[U,W],Y=t("button",{type:"button",class:"btn btn-dark rounded-none w-full"},"Button",-1),Z=t("button",{type:"button",class:"btn btn-dark rounded-none w-full"},"Button",-1),tt={class:"dropdown"},et={href:"javascript:;",class:"btn dropdown-toggle btn-dark rounded-t-none"},nt=["onClick"],ot=t("li",null,[t("a",{href:"javascript:;"},"Dropdown link")],-1),st=t("li",null,[t("a",{href:"javascript:;"},"Dropdown link")],-1),lt=[ot,st],rt=t("pre",null,`<!-- vertical -->
...
<\/script>
`,-1),pt=x({__name:"buttons-group",setup(dt){g({title:"Buttons Group"});const f=y(),{codeArr:a,toggleCode:i}=k();return(at,s)=>{const v=w("Popper");return d(),j("div",null,[C,t("div",D,[t("div",B,[t("div",P,[I,t("a",{class:"font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600",href:"javascript:;",onClick:s[0]||(s[0]=l=>e(i)("code1"))},[t("span",V,[n(b,{class:"me-2"}),r(" Code ")])])]),$,e(a).includes("code1")?(d(),u(c,{key:0},{default:o(()=>[N]),_:1})):p("",!0)]),t("div",A,[t("div",S,[G,t("a",{class:"font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600",href:"javascript:;",onClick:s[1]||(s[1]=l=>e(i)("code2"))},[t("span",M,[n(b,{class:"me-2"}),r(" Code ")])])]),z,e(a).includes("code2")?(d(),u(c,{key:0},{default:o(()=>[E]),_:1})):p("",!0)]),t("div",L,[t("div",R,[H,t("a",{class:"font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600",href:"javascript:;",onClick:s[2]||(s[2]=l=>e(i)("code3"))},[t("span",K,[n(b,{class:"me-2"}),r(" Code ")])])]),t("div",T,[t("div",q,[F,t("div",J,[n(v,{placement:e(f).rtlClass==="rtl"?"bottom-start":"bottom-end",offsetDistance:"0",class:"align-middle"},{content:o(({close:l})=>[t("ul",{onClick:h=>l()},X,8,Q)]),default:o(()=>[t("a",O,[r(" Dropdown "),n(m,{class:"ltr:ml-2 rtl:mr-2 inline-block shrink-0"})])]),_:1},8,["placement"])]),Y,Z,t("div",tt,[n(v,{placement:e(f).rtlClass==="rtl"?"top-start":"top-end",offsetDistance:"0",class:"align-middle"},{content:o(({close:l})=>[t("ul",{onClick:h=>l()},lt,8,nt)]),default:o(()=>[t("a",et,[r(" Dropdown "),n(m,{class:"ltr:ml-2 rtl:mr-2 inline-block shrink-0"})])]),_:1},8,["placement"])])])]),e(a).includes("code3")?(d(),u(c,{key:0},{default:o(()=>[rt]),_:1})):p("",!0)])])])}}});export{pt as default};
