...
<\/script>
`,-1),Ge={class:"panel"},$e={class:"flex items-center justify-between mb-5"},Xe=e("h5",{class:"font-semibold text-lg dark:text-white"},"Mixed",-1),Le={class:"flex items-center"},Pe={class:"mb-5"},Ee=e("pre",null,`<!-- mixed -->
...
<\/script>
`,-1),Ke={class:"panel"},qe={class:"flex items-center justify-between mb-5"},He=e("h5",{class:"font-semibold text-lg dark:text-white"},"Basic Pie",-1),Qe={class:"flex items-center"},Ze={class:"mb-5"},et=e("pre",null,`<!-- basic pie -->
