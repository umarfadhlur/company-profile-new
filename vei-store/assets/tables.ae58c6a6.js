import{c as A,_ as g}from"./codePreview.7600b617.js";import{d as I,i as E,j as L,r as $,a as D,J,b as s,c as l,e as t,l as n,g as a,f as r,F as y,y as x,t as o,x as k,G as p,w as d,K as b,B as _,aa as T,U as z,n as V,s as M}from"./index.5985d42f.js";import{I as v}from"./icon-code.a129f8a6.js";import{I as w}from"./icon-trash-lines.2bbd440c.js";import{I as C}from"./icon-x-circle.b6573b92.js";import{_ as j}from"./icon-pencil.vue_vue_type_script_setup_true_lang.74be3602.js";import{I as B}from"./icon-circle-check.397f521a.js";const F={class:"grid grid-cols-1 xl:grid-cols-2 gap-6"},H={class:"panel"},O={class:"flex items-center justify-between mb-5"},K=t("h5",{class:"font-semibold text-lg dark:text-white-light"},"Simple Table",-1),R={class:"flex items-center"},G={class:"mb-5"},U={class:"table-responsive"},X=t("thead",null,[t("tr",null,[t("th",null,"Name"),t("th",null,"Date"),t("th",null,"Sale"),t("th",{class:"text-center"},"Status"),t("th",{class:"text-center"},"Action")])],-1),Y={class:"whitespace-nowrap"},q={class:"text-center"},Q={type:"button"},W=t("pre",null,`<!-- basic table -->
...
<\/script>
`,-1),Jt={class:"panel"},Tt={class:"flex items-center justify-between mb-5"},zt=t("h5",{class:"font-semibold text-lg dark:text-white-light"},"Captions",-1),Vt={class:"flex items-center"},Mt={class:"mb-5"},Bt={class:"table-responsive"},Ft=t("thead",null,[t("tr",null,[t("th",null,"#"),t("th",null,"Name"),t("th",null,"Email"),t("th",null,"Status"),t("th",{class:"text-center"},"Register")])],-1),Ht={class:"whitespace-nowrap"},Ot={class:"text-center"},Kt=t("pre",null,`<!-- caption -->
<div class="table-responsive">
  <table>
    <thead>
      <tr>
