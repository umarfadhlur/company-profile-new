...
<\/script>
`,-1),Pt={class:"panel"},zt={class:"flex items-center justify-between mb-5"},Tt=e("h5",{class:"font-semibold text-lg dark:text-white-light"},"Select",-1),jt={class:"flex items-center"},qt={class:"mb-5"},At=e("option",{value:""},"Open this select menu",-1),Ut=e("option",{value:"1"},"One",-1),Gt=e("option",{value:"2"},"Two",-1),Ot=e("option",{value:"3"},"Three",-1),Zt=[At,Ut,Gt,Ot],It={key:0,class:"text-[#1abc9c] mt-1"},Mt={key:1,class:"text-danger mt-1"},Bt=e("button",{type:"submit",class:"btn btn-primary !mt-6"},"Submit Form",-1),Dt=e("pre",null,`<!-- select -->
