...
<\/script>
`,-1),Q={class:"panel"},G={class:"flex items-center justify-between mb-5"},J=t("h5",{class:"font-semibold text-lg dark:text-white-light"},"Dynamic queue",-1),E={class:"flex items-center"},X={class:"mb-5"},z={class:"flex items-center justify-center"},K=t("pre",null,`<!-- dynamic queue -->
...
<\/script>
`,-1),Et={class:"panel"},Xt={class:"flex items-center justify-between mb-5"},zt=t("h5",{class:"font-semibold text-lg dark:text-white-light"},'Execute something else for "Cancel".',-1),Kt={class:"flex items-center"},Zt={class:"mb-5"},te={class:"flex items-center justify-center"},ee=t("pre",null,`<!-- success message -->
...
<\/script>
`,-1),ce={class:"panel"},ue={class:"flex items-center justify-between mb-5"},de=t("h5",{class:"font-semibold text-lg dark:text-white-light"},"With Footer",-1),me={class:"flex items-center"},pe={class:"mb-5"},be={class:"flex items-center justify-center"},fe=t("pre",null,`<!-- success message -->
