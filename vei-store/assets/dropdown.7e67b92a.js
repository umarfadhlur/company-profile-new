import{c as g,_}from"./codePreview.e392b082.js";import{d as w,i as k,j,a as y,b as p,c as x,e as t,g as s,l,f as n,w as e,K as f,B as b,C as d,s as v}from"./index.24daf0ec.js";import{I as A}from"./icon-bell.042440b0.js";import{I as m}from"./icon-code.0fe44437.js";const C=t("ul",{class:"flex space-x-2 rtl:space-x-reverse"},[t("li",null,[t("a",{href:"javascript:;",class:"text-primary hover:underline"},"Elements")]),t("li",{class:"before:content-['/'] ltr:before:mr-2 rtl:before:ml-2"},[t("span",null,"Dropdowns")])],-1),S={class:"pt-5 space-y-8"},D={class:"panel p-3 flex items-center text-primary overflow-x-auto whitespace-nowrap"},P={class:"ring-2 ring-primary/30 rounded-full bg-primary text-white p-1.5 ltr:mr-3 rtl:ml-3"},$=t("span",{class:"ltr:mr-3 rtl:ml-3"},"Documentation: ",-1),B=t("a",{href:"https://www.npmjs.com/package/vue3-popper",target:"_blank",class:"block hover:underline"},"https://www.npmjs.com/package/vue3-popper",-1),L={class:"grid grid-cols-1 lg:grid-cols-2 gap-6"},I={class:"panel"},T={class:"flex items-center justify-between mb-5"},N=t("h5",{class:"font-semibold text-lg dark:text-white-light"},"Basic",-1),R={class:"flex items-center"},U={class:"mb-5"},V={class:"flex flex-wrap w-full justify-around gap-7"},E={class:"dropdown"},z={type:"button",class:"btn btn-primary dropdown-toggle"},G=["onClick"],H=t("li",null,[t("a",{href:"javascript:;"},"Action")],-1),K=t("li",null,[t("a",{href:"javascript:;"},"Another action")],-1),M=t("li",null,[t("a",{href:"javascript:;"},"Something else here")],-1),q=t("li",null,[t("a",{href:"javascript:;"},"Separated link")],-1),F=[H,K,M,q],J={class:"dropdown"},O={type:"button",class:"btn btn-outline-primary dropdown-toggle"},Q=["onClick"],W=t("li",null,[t("a",{href:"javascript:;"},"Action")],-1),X=t("li",null,[t("a",{href:"javascript:;"},"Another action")],-1),Y=t("li",null,[t("a",{href:"javascript:;"},"Something else here")],-1),Z=t("li",null,[t("a",{href:"javascript:;"},"Separated link")],-1),tt=[W,X,Y,Z],et=t("pre",null,`<!-- default -->
<div class="dropdown">
...
const store = useAppStore();
<\/script>
`,-1),ze={class:"panel"},Ge={class:"flex items-center justify-between mb-5"},He=t("h5",{class:"font-semibold text-lg dark:text-white-light"},"Large Button",-1),Ke={class:"flex items-center"},Me={class:"mb-5"},qe={class:"flex flex-wrap w-full justify-around gap-7"},Fe={class:"dropdown"},Je={type:"button",class:"btn btn-success btn-lg dropdown-toggle"},Oe=["onClick"],Qe=t("li",null,[t("a",{href:"javascript:;"},"Action")],-1),We=t("li",null,[t("a",{href:"javascript:;"},"Another action")],-1),Xe=t("li",null,[t("a",{href:"javascript:;"},"Something else here")],-1),Ye=t("li",null,[t("a",{href:"javascript:;"},"Separated link")],-1),Ze=[Qe,We,Xe,Ye],to={class:"dropdown"},eo={type:"button",class:"btn btn-outline-success btn-lg dropdown-toggle"},oo=["onClick"],so=t("li",null,[t("a",{href:"javascript:;"},"Action")],-1),lo=t("li",null,[t("a",{href:"javascript:;"},"Another action")],-1),no=t("li",null,[t("a",{href:"javascript:;"},"Something else here")],-1),ao=t("li",null,[t("a",{href:"javascript:;"},"Separated link")],-1),ro=[so,lo,no,ao],io=t("pre",null,`<!-- default -->
<div class="dropdown">
  <Popper :placement="store.rtlClass === 'rtl' ? 'bottom-start' : 'bottom-end'" offsetDistance="0" class="align-middle">
...
const store = useAppStore();
<\/script>
`,-1),Eo={class:"panel"},zo={class:"flex items-center justify-between mb-5"},Go=t("h5",{class:"font-semibold text-lg dark:text-white-light"},"Split",-1),Ho={class:"flex items-center"},Ko={class:"mb-5"},Mo={class:"flex flex-wrap w-full justify-around gap-7"},qo={class:"dropdown inline-flex"},Fo=t("button",{type:"button",class:"btn btn-primary ltr:rounded-r-none rtl:rounded-l-none"},"Action",-1),Jo=t("button",{type:"button",class:"btn dropdown-toggle btn-primary h-full ltr:rounded-l-none rtl:rounded-r-none border-l-[#4468fd] before:border-[5px] before:border-l-transparent before:border-r-transparent before:border-t-inherit before:border-b-0 before:inline-block before:border-t-white-light"},[t("span",{class:"sr-only"},"Toggle dropdown")],-1),Oo=["onClick"],Qo=t("li",null,[t("a",{href:"javascript:;"},"Action")],-1),Wo=t("li",null,[t("a",{href:"javascript:;"},"Another action")],-1),Xo=t("li",null,[t("a",{href:"javascript:;"},"Something else here")],-1),Yo=t("li",null,[t("a",{href:"javascript:;"},"Separated link")],-1),Zo=[Qo,Wo,Xo,Yo],ts={class:"dropdown inline-flex"},es=t("button",{type:"button",class:"btn btn-outline-primary ltr:rounded-r-none rtl:rounded-l-none"},"Action",-1),os=t("button",{type:"button",class:"btn btn-outline-primary h-full ltr:rounded-l-none rtl:rounded-r-none dropdown-toggle before:border-[5px] before:border-l-transparent before:border-r-transparent before:border-t-inherit before:border-b-0 before:inline-block hover:before:border-t-white-light"},[t("span",{class:"sr-only"},"Toggle dropdown")],-1),ss=["onClick"],ls=t("li",null,[t("a",{href:"javascript:;"},"Action")],-1),ns=t("li",null,[t("a",{href:"javascript:;"},"Another action")],-1),as=t("li",null,[t("a",{href:"javascript:;"},"Something else here")],-1),rs=t("li",null,[t("a",{href:"javascript:;"},"Separated link")],-1),is=[ls,ns,as,rs],cs=t("pre",null,`<!-- default -->
