...
<\/script>
`,-1),Pt={class:"panel"},jt={class:"flex items-center justify-between mb-5"},Vt=e("h5",{class:"font-semibold text-lg dark:text-white-light"},"Copy form Textarea",-1),Bt={class:"flex items-center"},It={class:"mb-5"},Nt={class:"bg-[#f1f2f3] p-5 rounded dark:bg-[#060818]"},Rt={class:"flex flex-wrap gap-2 mt-5"},$t=e("pre",null,`<!-- copy from textare -->
<form>
...
<\/script>
`,-1),Dt={class:"panel"},Zt={class:"flex items-center justify-between mb-5"},Ft=e("h5",{class:"font-semibold text-lg dark:text-white-light"},"Copy Text from Paragraph",-1),Ut={class:"flex items-center"},zt={class:"mb-5"},Yt={class:"bg-[#f1f2f3] p-5 rounded dark:bg-[#060818]"},Gt=e("p",{class:"mb-3 font-semibold"},[g("Here is your OTP "),e("span",{class:"text-2xl",id:"copyOTP"},"22991"),g(".")],-1),Kt=e("p",{class:"font-semibold"},"Please do not share it to anyone",-1),Xt={class:"flex flex-wrap gap-2 mt-5"},Jt=e("pre",null,`<!-- copy from paragraph -->
<form>
...
<\/script>
`,-1),me=ut({__name:"clipboard",setup(S){dt({title:"Clipboard"});const{codeArr:T,toggleCode:L}=mt(),C=z("http://www.admin-dashboard.com"),b=z("Lorem ipsum dolor sit amet, consectetur adipiscing elit..."),{toClipboard:f}=vt(),s=async a=>{a&&(await f(a),c("Copied successfully."))},t=async a=>{a&&(await f(a),c("Cut successfully."))},c=(a="",o="success")=>{ft.mixin({toast:!0,position:"top",showConfirmButton:!1,timer:3e3,customClass:{container:"toast"}}).fire({icon:o,title:a,padding:"10px 20px"})};return(a,o)=>(A(),pt("div",null,[bt,e("div",gt,[e("div",Ct,[e("div",wt,[x(yt)]),xt,_t]),e("div",kt,[e("div",Lt,[e("div",Tt,[Et,e("a",{class:"font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600",href:"javascript:;",onClick:o[0]||(o[0]=d=>E(L)("code1"))},[e("span",St,[x(R,{class:"me-2"}),g(" Code ")])])]),e("div",Mt,[e("div",At,[e("form",null,[Y(e("input",{type:"text",class:"form-input","onUpdate:modelValue":o[1]||(o[1]=d=>C.value=d),id:"message1"},null,512),[[G,C.value]]),e("div",Ot,[e("button",{type:"button",class:"btn btn-primary",onClick:o[2]||(o[2]=d=>s(C.value))},[x(O,{class:"ltr:mr-2 rtl:ml-2"}),g(" Copy from Input ")]),e("button",{type:"button",class:"btn btn-dark",onClick:o[3]||(o[3]=d=>t(C.value)),onBlur:o[4]||(o[4]=d=>C.value="")},[x(K,{class:"ltr:mr-2 rtl:ml-2"}),g(" Cut from Input ")],32)])])])]),E(T).includes("code1")?(A(),V(N,{key:0},{default:B(()=>[Ht]),_:1})):I("",!0)]),e("div",Pt,[e("div",jt,[Vt,e("a",{class:"font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600",href:"javascript:;",onClick:o[5]||(o[5]=d=>E(L)("code2"))},[e("span",Bt,[x(R,{class:"me-2"}),g(" Code ")])])]),e("div",It,[e("div",Nt,[e("form",null,[Y(e("textarea",{rows:"3",wrap:"soft",class:"form-textarea","onUpdate:modelValue":o[6]||(o[6]=d=>b.value=d),id:"message2"},null,512),[[G,b.value]]),e("div",Rt,[e("button",{type:"button",class:"btn btn-primary",onClick:o[7]||(o[7]=d=>s(b.value))},[x(O,{class:"ltr:mr-2 rtl:ml-2"}),g(" Copy from Input ")]),e("button",{type:"button",class:"btn btn-dark",onClick:o[8]||(o[8]=d=>t(b.value)),onBlur:o[9]||(o[9]=d=>b.value="")},[x(K,{class:"ltr:mr-2 rtl:ml-2"}),g(" Cut from Input ")],32)])])])]),E(T).includes("code2")?(A(),V(N,{key:0},{default:B(()=>[$t]),_:1})):I("",!0)]),e("div",Dt,[e("div",Zt,[Ft,e("a",{class:"font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600",href:"javascript:;",onClick:o[10]||(o[10]=d=>E(L)("code3"))},[e("span",Ut,[x(R,{class:"me-2"}),g(" Code ")])])]),e("div",zt,[e("div",Yt,[e("form",null,[Gt,Kt,e("div",Xt,[e("button",{type:"button",class:"btn btn-primary",onClick:o[11]||(o[11]=d=>s("22991"))},[x(O,{class:"ltr:mr-2 rtl:ml-2"}),g(" Copy from Paragraph ")])])])])]),E(T).includes("code3")?(A(),V(N,{key:0},{default:B(()=>[Jt]),_:1})):I("",!0)]),e("div",Qt,[e("div",Wt,[qt,e("a",{class:"font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600",href:"javascript:;",onClick:o[12]||(o[12]=d=>E(L)("code4"))},[e("span",te,[x(R,{class:"me-2"}),g(" Code ")])])]),e("div",ee,[e("div",oe,[e("form",null,[ne,re,e("div",se,[e("button",{type:"button",class:"btn btn-primary",onClick:o[13]||(o[13]=d=>s("http://www.admin-dashboard.com/code"))},[x(O,{class:"ltr:mr-2 rtl:ml-2"}),g(" Copy Link ")]),e("button",{type:"button",class:"btn btn-dark",onClick:o[14]||(o[14]=d=>s("2291"))},[x(O,{class:"ltr:mr-2 rtl:ml-2"}),g(" Copy Hidden Code ")])])])])]),E(T).includes("code4")?(A(),V(N,{key:0},{default:B(()=>[ie]),_:1})):I("",!0)])])])]))}});export{me as default};
