...
`,-1),F={class:"panel"},R={class:"flex items-center justify-between mb-5"},U=t("h5",{class:"font-semibold text-lg dark:text-white-light"},"Placement",-1),G={class:"flex items-center"},J={class:"mb-5"},K={class:"flex flex-wrap justify-center gap-4 w-full"},q={type:"button",class:"btn btn-info"},z={type:"button",class:"btn btn-secondary"},Q={type:"button",class:"btn btn-warning"},X={type:"button",class:"btn btn-danger"},Y=t("pre",null,`<!-- top -->
