...
<\/script>
`,-1),_e=M({__name:"countdown",setup(he){j({title:"Countdown"});const{codeArr:i,toggleCode:m}=D(),h=n(null),s=n({days:null,hours:null,minutes:null,seconds:null}),u=n(null),r=n({days:null,hours:null,minutes:null,seconds:null});C(()=>{k(),g()});const k=()=>{let o=new Date;o.setDate(o.getDate()+3);let d=o.getTime();h.value=setInterval(()=>{let a=new Date().getTime(),t=d-a;s.value.days=Math.floor(t/(1e3*60*60*24)),s.value.hours=Math.floor(t%(1e3*60*60*24)/(1e3*60*60)),s.value.minutes=Math.floor(t%(1e3*60*60)/(1e3*60)),s.value.seconds=Math.floor(t%(1e3*60)/1e3),t<0&&clearInterval(h.value)},500)},g=()=>{let o=new Date;o.setFullYear(o.getFullYear()+1);let d=o.getTime();u.value=setInterval(()=>{let a=new Date().getTime(),t=d-a;r.value.days=Math.floor(t/(1e3*60*60*24)),r.value.hours=Math.floor(t%(1e3*60*60*24)/(1e3*60*60)),r.value.minutes=Math.floor(t%(1e3*60*60)/(1e3*60)),r.value.seconds=Math.floor(t%(1e3*60)/1e3),t<0&&clearInterval(u.value)},500)};return(o,d)=>(c(),T("div",null,[I,e("div",S,[e("div",B,[e("div",F,[H,e("a",{class:"font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600",href:"javascript:;",onClick:d[0]||(d[0]=a=>x(m)("code1"))},[e("span",N,[f(y,{class:"me-2"}),_(" Code ")])])]),e("div",V,[e("div",null,[e("div",Y,[e("h1",$,l(s.value.days),1)]),A]),e("div",null,[e("div",E,[e("h1",K,l(s.value.hours),1)]),P]),e("div",null,[e("div",q,[e("h1",z,l(s.value.minutes),1)]),G]),e("div",null,[e("div",J,[e("h1",L,l(s.value.seconds),1)]),O])]),x(i).includes("code1")?(c(),b(p,{key:0},{default:v(()=>[Q]),_:1})):w("",!0)]),e("div",R,[e("div",U,[W,e("a",{class:"font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600",href:"javascript:;",onClick:d[1]||(d[1]=a=>x(m)("code2"))},[e("span",X,[f(y,{class:"me-2"}),_(" Code ")])])]),e("div",Z,[e("div",null,[e("div",ee,[e("h1",te,l(r.value.days),1)]),se]),e("div",null,[e("div",re,[e("h1",oe,l(r.value.hours),1)]),de]),e("div",null,[e("div",le,[e("h1",ae,l(r.value.minutes),1)]),ne]),e("div",null,[e("div",xe,[e("h1",ce,l(r.value.seconds),1)]),ie])]),x(i).includes("code2")?(c(),b(p,{key:0},{default:v(()=>[me]),_:1})):w("",!0)])])]))}});export{_e as default};
