import{c as C,_ as m}from"./codePreview.3e0f30ff.js";import{q as p}from"./vue3-quill.33b5ac12.js";import{d as x,i as _,r,b as s,c as P,e,g as a,l as i,f as d,K as v,w as b,B as f}from"./index.84bf9faa.js";import{I as V}from"./icon-bell.7be3ea13.js";import{I as q}from"./icon-code.87b52d55.js";const A=e("ul",{class:"flex space-x-2 rtl:space-x-reverse"},[e("li",null,[e("a",{href:"javascript:;",class:"text-primary hover:underline"},"Forms")]),e("li",{class:"before:content-['/'] ltr:before:mr-2 rtl:before:ml-2"},[e("span",null,"Quill Editor")])],-1),k={class:"pt-5 space-y-8"},N={class:"panel p-3 flex items-center text-primary overflow-x-auto whitespace-nowrap"},y={class:"ring-2 ring-primary/30 rounded-full bg-primary text-white p-1.5 ltr:mr-3 rtl:ml-3"},w=e("span",{class:"ltr:mr-3 rtl:ml-3"},"Documentation: ",-1),M=e("a",{href:"https://www.npmjs.com/package/vue3-quill",target:"_blank",class:"block hover:underline"},"https://www.npmjs.com/package/vue3-quill",-1),S={class:"grid grid-cols-1 lg:grid-cols-2 gap-6"},E={class:"panel"},U={class:"flex items-center justify-between mb-5"},D=e("h5",{class:"font-semibold text-lg dark:text-white-light"},"Basic",-1),I={class:"flex items-center"},j={class:"mb-5"},B=e("pre",null,`<!-- basic -->
...
<\/script>
`,-1),Q={class:"panel"},T={class:"flex items-center justify-between mb-5"},L=e("h5",{class:"font-semibold text-lg dark:text-white-light"},"With Tooltip",-1),$={class:"flex items-center"},F={class:"mb-5"},K=e("pre",null,`<!-- with tooltip -->
...
<\/script>
`,-1),X=x({__name:"quill-editor",setup(W){_({title:"Quill Editor"});const{codeArr:l,toggleCode:n}=C(),g=r({modules:{toolbar:[[{header:[1,2,!1]}],["bold","italic","underline","link"],[{list:"ordered"},{list:"bullet"}],["clean"]]},placeholder:""}),o=r(`<h1>This is a heading text...</h1>
            <br />
            <p>
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla dui arcu, pellentesque id mattis sed, mattis semper erat. Etiam commodo arcu a mollis consequat. Curabitur pretium auctor
              tortor, bibendum placerat elit feugiat et. Ut ac turpis nec dui ullamcorper ornare. Vestibulum finibus quis magna at accumsan. Praesent a purus vitae tortor fringilla tempus vel non
            ...
            <p>
              ...
              leo venenatis pretium. Sed aliquet sem nunc, ut iaculis dolor consectetur et. Vivamus ligula sapien, maximus nec pellentesque ut, imperdiet at libero. Vivamus semper nulla lectus, id
              dapibus nulla convallis id. Quisque elementum lectus ac dui gravida, ut molestie nunc convallis. Pellentesque et odio non dolor convallis commodo sit amet a ante.
            </p>`);return(z,t)=>(s(),P("div",null,[A,e("div",k,[e("div",N,[e("div",y,[a(V)]),w,M]),e("div",S,[e("div",E,[e("div",U,[D,e("a",{class:"font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600",href:"javascript:;",onClick:t[0]||(t[0]=u=>i(n)("code1"))},[e("span",I,[a(q,{class:"me-2"}),d(" Code ")])])]),e("div",j,[a(i(p),{ref:"editor1",value:o.value,"onUpdate:value":t[1]||(t[1]=u=>o.value=u),options:g.value,style:{"min-height":"200px"}},null,8,["value","options"])]),i(l).includes("code1")?(s(),v(m,{key:0},{default:b(()=>[B]),_:1})):f("",!0)]),e("div",Q,[e("div",T,[L,e("a",{class:"font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600",href:"javascript:;",onClick:t[2]||(t[2]=u=>i(n)("code2"))},[e("span",$,[a(q,{class:"me-2"}),d(" Code ")])])]),e("div",F,[a(i(p),{ref:"editor2",value:c.value,"onUpdate:value":t[3]||(t[3]=u=>c.value=u),options:h.value,style:{"min-height":"200px"}},null,8,["value","options"])]),i(l).includes("code2")?(s(),v(m,{key:0},{default:b(()=>[K]),_:1})):f("",!0)])])])]))}});export{X as default};
