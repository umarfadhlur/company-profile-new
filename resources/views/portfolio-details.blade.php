                ...
                <div class="col-lg-10 mx-auto" data-aos="fade-up" data-aos-delay="300">
                    ...
                    <div class="row align-items-start mb-5" data-aos="fade-up" data-aos-delay="400">
                        ...
                        <div class="col-md-6 mb-4" data-aos="fade-up" data-aos-delay="500">
                            <p><strong>{{ __('Client') }}:</strong><br> {{ $project->client_name }}</p>
                            <p><strong>{{ __('Main Contractor') }}:</strong><br> {{ $project->contractor_name }}</p>
                            <p><strong>{{ __('Working Period') }}:</strong><br> {{ $project->duration }}</p>
                            <p><strong>{{ __('Scope of Work') }}:</strong><br> {{ $project->scope_of_work }}</p>
                            <p><strong>{{ __('Category of Work') }}:</strong><br> {{ $project->category_of_work }}</p>
                        </div>
                                ...
                                <div id="projectPhotosCarousel" class="carousel slide" data-bs-ride="carousel">
                                        ...
                                        @foreach ($project->photos as $key => $photo)
                                            <div class="carousel-item {{ $key == 0 ? 'active' : '' }}">
                                                <img src="{{ asset('storage/' . $photo->photo_path) }}"
                                                    class="d-block w-100 rounded shadow" alt="{{ __('Project Photo') }}"
                                    ...
                                    @if ($project->photos->count() > 1)
                                        <button class="carousel-control-prev" type="button"
                                            data-bs-target="#projectPhotosCarousel" data-bs-slide="prev">
                                            <span class="carousel-control-prev-icon"></span>
                                        </button>
                                        <button class="carousel-control-next" type="button"
                                            data-bs-target="#projectPhotosCarousel" data-bs-slide="next">
                    ...
                    <div class="text-center" data-aos="fade-up" data-aos-delay="700">
                        <a href="{{ url('/#projects') }}" class="btn btn-dark px-4 py-2"
                            style="background:#1a7eb8; border:none;">
                            {{ __('Back to Projects') }}
                        </a>
                    </div>
