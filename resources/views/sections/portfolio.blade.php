<section id="projects" class="portfolio section">
    ...
    <div class="container section-title" data-aos="fade-up">
        <p><span class="description-title">{{ __('Projects') }}</span></p>
    </div>

    <div class="container">
        <div class="mb-4" style="font-size:1.1rem;" data-aos="fade-up" data-aos-delay="120">
            {{ __('Trusted by national and multinational companies, our portfolio includes power plant construction (PLTU & CCPP), oil and gas refinery works, industrial pipeline networks, large-scale steel structures, and mechanical equipment maintenance.') }}
        </div>
        ...
        <div class="isotope-layout" data-default-filter="*" data-layout="masonry" data-sort="original-order">
            ...
            <div class="row gy-4 isotope-container" data-aos="fade-up" data-aos-delay="200">
                ...
                @forelse($projects as $project)
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-{{ $categorySlug }}">
                        ...
                        <div class="portfolio-info">
                            ...
                            <a href="{{ $image }}" title="{{ $project->project_name }}"
                                data-gallery="portfolio-gallery-{{ $categorySlug }}" class="glightbox preview-link">
                                <i class="bi bi-zoom-in"></i>
                            </a>

                            <a href="{{ route('project.detail', $project->slug) }}" title="{{ __('More Details') }}"
                                class="details-link">
                ...
                @empty
                    <div class="col-12">
                        <p class="text-muted">{{ __('No projects available at the moment.') }}</p>
                    </div>
                @endforelse
